!(function (a, b) {
  ...
  return (
      ...
      (b.namespaces = {
        ...
        (b.normalizeData = function (a, c, d) {
          var e,
            f = { raw: a, normalized: {} };
          return (
            (f.normalized.series = b.getDataArray(
              { series: a.series || [] },
              c,
              d
            )),
          ...
          function e(a) {
            ...
            if (!b.isDataHoleValue(a)) {
              if (d) {
                ...
                return (
                  "string" == typeof d
                    ? (c[d] = b.getNumberOrUndefined(a))
                    : (c.y = b.getNumberOrUndefined(a)),
                  (c.x = a.hasOwnProperty("x")
                    ? b.getNumberOrUndefined(a.x)
                    : c.x),
                  (c.y = a.hasOwnProperty("y")
                    ? b.getNumberOrUndefined(a.y)
                    : c.y),
                  c
                );
              }
        ...
        (b.getAvailableHeight = function (a, c) {
          return Math.max(
            (b.quantity(c.height).value || a.height()) -
              (c.chartPadding.top + c.chartPadding.bottom) -
              c.axisX.offset,
            0
          );
        }),
        (b.getHighLow = function (a, c, d) {
          ...
          return (
            ...
            (c.referenceValue || 0 === c.referenceValue) &&
              ((f.high = Math.max(c.referenceValue, f.high)),
              (f.low = Math.min(c.referenceValue, f.low))),
            f.high <= f.low &&
              (0 === f.low
                ? (f.high = 1)
                : f.low < 0
        ...
        (b.getMultiValue = function (a, c) {
          return b.isMultiValue(a)
            ? b.getNumberOrUndefined(a[c || "y"])
            : b.getNumberOrUndefined(a);
        }),
        (b.rho = function (a) {
          function b(a, c) {
        ...
        (b.getBounds = function (a, c, d, e) {
          ...
          var o = 2.221e-16;
          for (
            k.step = Math.max(k.step, o), h = k.min, i = k.max;
            h + k.step <= k.low;
        ...
        (b.createLabel = function (a, c, e, f, g, h, i, j, k, l, m) {
          ...
          if (
            ...
            (p.className = k.join(" ")),
              ...
              (n = j.foreignObject(
                p,
                b.extend({ style: "overflow: visible;" }, o)
              ));
    ...
    (function (a, b) {
      ...
      (b.Interpolation = {}),
        ...
        (b.Interpolation.simple = function (a) {
          ...
          return function (c, e) {
            for (
              var f, g, h, i = new b.Svg.Path(), j = 0;
              j < c.length;
              j += 2
            ) {
              var k = c[j],
        ...
        (b.Interpolation.cardinal = function (a) {
          ...
          return function f(c, g) {
            ...
            if (h.length) {
              ...
              for (
                var j,
                  k = new b.Svg.Path().move(c[0], c[1], !1, g[0]),
                  l = 0,
                  m = c.length;
                m - 2 * !j > l;
                l += 2
                ...
                for (m[0] = n[0], m[l - 1] = n[l - 2], h = 1; h < l - 1; h++)
                  0 === n[h] || 0 === n[h - 1] || n[h - 1] > 0 != n[h] > 0
                    ...
                    : ((m[h] =
                      ...
                      isFinite(m[h]) || (m[h] = 0));
                for (
                  i = new b.Svg.Path().move(j[0], k[0], !1, e[0]), h = 0;
                  h < l - 1;
                  h++
                )
                  i.curve(
        ...
        (b.Interpolation.step = function (a) {
          ...
          return (
            ...
            function (c, d) {
              for (
                var e, f, g, h = new b.Svg.Path(), i = 0;
                i < c.length;
                i += 2
              ) {
                var j = c[i],
    ...
    (function (a, b) {
      ...
      function d(a, c) {
        ...
        var f = function () {
          ...
          return (
            (a = this === b ? Object.create(e) : this),
            c.apply(a, Array.prototype.slice.call(arguments, 0)),
            a
          );
        };
    ...
    (function (a, b) {
        ...
        return (
          ...
          c &&
            ...
            this.initializeTimeoutId ||
              ...
              (this.optionsProvider = b.optionsProvider(
                this.options,
      ...
      function d() {
        return (
          this.initializeTimeoutId
            ...
            : (i.removeEventListener("resize", this.resizeListener),
              this.optionsProvider.removeMediaQueryListeners()),
          this
        );
      }
      ...
      function h(a, c, d, e, f) {
        (this.container = b.querySelector(a)),
          ...
          (this.supportsAnimations = b.Svg.isSupported(
    ...
    (function (a, b) {
      ...
      function f() {
        return this._node.parentNode instanceof SVGElement
          ? new b.Svg(this._node.parentNode)
          : null;
      }
      function g() {
      ...
      function x(a) {
        ...
        for (var d = 0; d < a.length; d++)
          this.svgElements.push(new b.Svg(a[d]));
      ...
      (b.Svg = b.Class.extend({
        ...
        (b.Svg.isSupported = function (a) {
          return y.implementation.hasFeature(
    ...
    (function (a, b) {
      ...
      function h(a, b, d, e) {
        return (
          c("M", { x: +a, y: +b }, this.pathElements, this.pos++, d, e), this
        );
      }
      function i(a, b, d, e) {
        return (
          c("L", { x: +a, y: +b }, this.pathElements, this.pos++, d, e), this
        );
      }
        ...
        return (
          this.pathElements.forEach(function (d) {
            d.command === a.toUpperCase() &&
              0 !== c[c.length - 1].pathElements.length &&
              c.push(new b.Svg.Path()),
    ...
    (function (a, b) {
      ...
      function c(a, c, d, e) {
        ...
        (this.bounds = b.getBounds(
          ...
          b.AutoScaleAxis["super"].constructor.call(
            this,
            a,
            d,
            this.bounds.values,
      ...
      function d(a) {
        return (
          (this.axisLength *
            (+b.getMultiValue(a, this.units.pos) - this.bounds.min)) /
          this.bounds.range
        );
      }
      a.window, a.document;
    ...
    (function (a, b) {
      ...
      function d(a) {
        return (
          (this.axisLength *
            (+b.getMultiValue(a, this.units.pos) - this.range.min)) /
          ...
          c.raw.series.forEach(
            function (e, g) {
              ...
              i.attr({
                ...
                i.addClass(
                  [
                    a.classNames.series,
                    e.className ||
                      a.classNames.series + "-" + b.alphaNumerate(g),
                  ].join(" ")
                );
              var k = [],
                l = [];
                  ...
                  o.pathElements.forEach(
                    function (c) {
                      var h = i
                        ...
                        .attr({
                          "ct:value": [c.data.value.x, c.data.value.y]
                            .filter(b.isNumeric)
                            .join(","),
              ...
              if (m.showArea && f.range) {
                var q = Math.max(
                    Math.min(m.areaBase, f.range.max),
                    f.range.min
                  ),
        ...
        (k =
          ...
          a.horizontalBars
            ? ((j = m =
              ...
              (l = n =
                void 0 === a.axisY.type
                  ? new b.StepAxis(b.Axis.units.y, c.normalized.series, o, {
                      ticks: k,
                    })
                  : a.axisY.type.call(
                      b,
            ...
            : ((l = m =
                void 0 === a.axisX.type
                  ? new b.StepAxis(b.Axis.units.x, c.normalized.series, o, {
                      ticks: k,
                    })
                  : a.axisX.type.call(
                      b,
              ...
              (f =
                ...
                h.addClass(
                  [
                    a.classNames.series,
                    d.className ||
                      a.classNames.series + "-" + b.alphaNumerate(e),
                  ].join(" ")
                ),
            ...
            function (e, f) {
              if (0 !== j.normalized.series[f] || !a.ignoreEmptyValues) {
                k[f].attr({ "ct:series-name": e.name }),
                  k[f].addClass(
                    [
                      a.classNames.series,
                      e.className ||
                        a.classNames.series + "-" + b.alphaNumerate(f),
                    ].join(" ")
                  );
                ...
                var r,
                  ...
                  w = new b.Svg.Path(!a.donut || a.donutSolid)
                    .move(v.x, v.y)
                    .arc(g, g, 0, p - l > 180, 0, u.x, u.y);
                a.donut
                  ? a.donutSolid &&
                    ((t = g - m.value),
                    (r = b.polarToCartesian(
                      n.x,
                      n.y,
                      t,
                      l - (0 === f || o ? 0 : 0.2)
                ...
                if (
                  ...
                  A =
                    j.normalized.labels &&
                    !b.isFalseyButZero(j.normalized.labels[f])
