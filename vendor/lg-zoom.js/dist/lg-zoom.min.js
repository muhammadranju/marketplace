          ...
          !(function (t, o) {
            ...
            (r.prototype.init = function () {
              ...
              var o = 1,
                r = function t(o) {
                  var r = e.core.outer.querySelector(".lg-current .lg-image"),
                    l,
                    i,
                    a = (window.innerWidth - r.clientWidth) / 2,
                    s =
                ...
                i = function t(r, i, a, s) {
                  var n = i.clientWidth,
                    u;
                  u = e.core.s.dynamic
                    ? e.core.s.dynamicEl[a].width || i.naturalWidth || n
                    : e.core.items[a].getAttribute("data-width") ||
                      i.naturalWidth ||
                      n;
                  var c;
              ...
              (r.prototype.zoomSwipe = function () {
                for (
                  var e = this, t = {}, o = {}, r = !1, l = !1, i = !1, a = 0;
                  a < e.core.___slide.length;
                  a++
                )
                  utils.on(e.core.___slide[a], "touchstart.lg", function (o) {
                ...
                for (var s = 0; s < e.core.___slide.length; s++)
                  utils.on(e.core.___slide[s], "touchmove.lg", function (a) {
                    if (utils.hasClass(e.core.outer, "lg-zoomed")) {
                      var s = e.core.___slide[e.core.index].querySelector(
                          ".lg-img-wrap"
                        ),
                        n,
                        u;
                      a.preventDefault(),
                        ...
                        (u = i
                          ? -Math.abs(s.getAttribute("data-y")) + (o.y - t.y)
                          : -Math.abs(s.getAttribute("data-y"))),
                        (n = l
                          ? -Math.abs(s.getAttribute("data-x")) + (o.x - t.x)
                          : -Math.abs(s.getAttribute("data-x"))),
                        (Math.abs(o.x - t.x) > 15 ||
                          Math.abs(o.y - t.y) > 15) &&
                          (e.core.s.useLeftForZoom
                            ? ((s.style.left = n + "px"),
              ...
              (r.prototype.zoomDrag = function () {
                for (
                  ...
                  utils.on(e.core.___slide[s], "mousedown.lgzoom", function (
                    o
                  ) {
              ...
              (r.prototype.touchendZoom = function (e, t, o, r) {
                var l = this,
                  ...
                  u =
                    ...
                    2,
                  c = Math.abs(
                    a.offsetHeight * Math.abs(a.getAttribute("data-scale")) -
                      l.core.outer.querySelector(".lg").clientHeight +
                      u
                  ),
                  d =
                    ...
                    2,
                  g = Math.abs(
                    a.offsetWidth * Math.abs(a.getAttribute("data-scale")) -
                      l.core.outer.querySelector(".lg").clientWidth +
                      d
                  );
                (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) &&
                  ...
                  o
                    ? i.setAttribute("data-x", Math.abs(s))
                    : (s = -Math.abs(i.getAttribute("data-x"))),
                  l.core.s.useLeftForZoom
                    ? ((i.style.left = s + "px"), (i.style.top = n + "px"))
                    : utils.setVendor(
                        i,
                        "Transform",
