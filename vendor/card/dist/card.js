      ...
      /* WEBPACK VAR INJECTION */ (function (global) {
        ...
        Card = (function () {
          ...
          function Card(opts) {
            ...
            toInitialize = QJ.isDOMElement(this.$container)
              ? this.$container
              : this.$container[0];
          ...
          Card.prototype.render = function () {
            ...
            if (this.options.width) {
              ...
              baseWidth = parseInt(
                $cardContainer.clientWidth ||
                  window.getComputedStyle($cardContainer).width
              );
          ...
          Card.prototype.validToggler = function (validatorName) {
            ...
            if (validatorName === "cardExpiry") {
              isValid = function (val) {
                ...
                return Payment.fns.validateCardExpiry(
                  objVal.month,
                  objVal.year
                );
              };
          ...
          Payment = (function () {
            ...
            Payment.fns = {
              ...
              cardType: function (num) {
                ...
                return (
                  ((ref = cardFromNumber(num)) != null ? ref.type : void 0) ||
                  null
                );
              },
